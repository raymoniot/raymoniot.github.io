...
Main usage flow of the platform:

1. Log in to the platform with an account (the account is created by the platform provider or by the administrator of your organization), see [Login]({{< ref "login/login" >}} "Login")
2. If you are responsible for on-site installation: first configure the network of the collector with the App, then import the collector, see [Quick Start]({{< ref "quickStart" >}} "Quick Start")
3. Create a plant and bind the collector to the plant, see [Create Plant]({{< ref "plant-center/create-plant" >}} "Create Plant") and [Add Collector]({{< ref "plant-center/add-logger" >}} "Add Collector")
4. After the plant and the devices start to report data, use [Data Dashboard]({{< ref "dashboard" >}} "Data Dashboard"), [Plant Center]({{< ref "plant-center" >}} "Plant Center") and [Device Center]({{< ref "device" >}} "Device Center") in daily work, and handle alarms and work orders in the [Operation and Maintenance Center]({{< ref "ops" >}} "Operation and Maintenance Center")
...
- Formal account: the account is created by the platform provider or by the administrator of your organization in "Organization management → Organizational Structure". The visible data range of an account is decided by the **Data Permissions**, **Role** and **Measurement Group** of the member.
