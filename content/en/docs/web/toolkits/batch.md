...
description: Batch command transmission, parameter setting, firmware upgrade for multiple devices, including creating tasks, redoing failed devices, etc.
weight: 2
---

# Function Overview

Batch parameter setting, firmware upgrade, command transmission, etc. for devices
...
If the batch operation task fails, you can use the redo function to redo the failed devices in the batch task.