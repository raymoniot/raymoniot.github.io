---
title: Customer Team
description: "Customer Team management: create, modify and dissolve teams, set responsibilities and members"
weight: 4
---
...
- **Team name**: required, a name that is easy to identify
- **Description**: supplementary information about the team
- **Main responsibilities**: select one or more work order types (such as complaint, problem, return or exchange); work orders are assigned by type to the team responsible for that type
- **Main members**: select at least one member; members are the handlers of this team
