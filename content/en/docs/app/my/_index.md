...
- **Config Network**: configure the network of a logger, see [Network Configuration]({{< ref "config" >}} "Network Configuration")
- **OTA Helper**: firmware upgrade (OTA) of devices and loggers
- **Local Debug**: connect to a device over Bluetooth for local debugging, see [Local Debugging]({{< ref "bleDebug" >}} "Local Debugging")
