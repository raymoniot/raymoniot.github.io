...
1. Select a power station in the power station list to enter the power station overview page
2. Click Add Collector in the upper right corner of the power station overview page
3. Scan the code or click the keyboard icon to enter the manual input interface
4. Manually enter the collector SN number and click Add Device