---
title: 光伏系统
description: 光伏系统电站的概览、列表、地图、大屏与电站详情页：图表统计与导出、设备、告警、布局、资料、添加采集器、新建工单、发电修补
weight: 6
---

# 功能概述

光伏系统页面用于管理业务类型为光伏系统的电站：上方是电站概览指标，下方通过「电站列表」「电站地图」两个标签页查看和查找电站，点击电站进入电站详情页。页面右上角的「添加电站」「系统大屏」分别用于新建电站和全屏展示。
...
列表中的信息包括：状态、电站名称和地址、电站业主、光伏装机容量、发电功率、今日满发小时、日发电量、建站日期、时区、数据更新时间。

- 上方的状态标签会显示各状态的电站数量，点击即可只看该状态的电站
...
地图上的标记按电站的在线状态着色，点击标记或搜索结果可以进入该电站的详情页。
...
- **基本信息**：电站名称、电站地址、电站业主、光伏装机容量、并网类型等
- **更多信息**：建站日期、时区、度电收益、总成本、联系人、联系电话等
