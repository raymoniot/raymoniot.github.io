...
<img src="/../../zh/photo/docs/toolkits/batch-enter.webp">

批量操作以「任务」为单位：先把设备加到任务里，再选择操作内容提交，平台按台执行并统计成功、失败数量，失败的设备可以重做。列表中的每行显示任务的失败/成功/处理中/全部数量、操作内容、创建者和创建时间。

## 1.创建任务

<img src="/../../zh/photo/docs/toolkits/batch-add.webp">

<img src="/../../zh/photo/docs/toolkits/batch-add1.webp" width="700" height="550">

可以按照指定设备类型和电站进行设备的筛选

先按状态、设备类型、程序版本、序列号、电站名称筛选出目标设备（左栏），勾选后点击「添加」放入右栏，即为本次任务要操作的设备。

<img src="/../../zh/photo/docs/toolkits/batch-add2.webp" width="700" height="550">

选择设备类型，选择设备列表中的设备，添加设备

<img src="/../../zh/photo/docs/toolkits/batch-add3.webp" width="700" height="550">
...
<img src="/../../zh/photo/docs/toolkits/batch-redo.webp">
